...
from src.gplearn.gplearn.genetic import SymbolicClassifier, SymbolicRegressor
from src.gplearn.gplearn.genetic import SymbolicTransformer
from src.gplearn.gplearn.functions import make_function
...
def test_symbolic_regressor():
    ...
    est_gp.fit(X_train, y_train, start_population=["mul x_1 0" for i in range(500)])
